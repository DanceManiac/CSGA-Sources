...
//.	VERIFY(item || inventory_owner);
	...
	HUD().Font().GetFont("ui_font_letterica16_russian")->SetAligment	(CGameFont::alCenter);
	HUD().Font().GetFont("ui_font_letterica16_russian")->SetColor		(PICKUP_INFO_COLOR);
	HUD().Font().GetFont("ui_font_letterica16_russian")->Out			(x,y,draw_str);
}
