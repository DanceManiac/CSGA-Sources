...
//.				value("kWPN_PREV",					int(kWPN_PREV)),
                ...
                value("kSTART_ADJUST",				int(kSTART_ADJUST)),
				value("kADJ_SET_1M",				int(kADJ_SET_1M)),
				value("kADJ_SET_2M",				int(kADJ_SET_2M)),
				value("kADJ_SET_3M",				int(kADJ_SET_3M)),
				value("kADJ_SET_4M",				int(kADJ_SET_4M)),
				value("kADJ_SET_5M",				int(kADJ_SET_5M)),
				...
				value("kADJ_RIGHT",					int(kADJ_RIGHT)),
				value("kADJ_FORWARD",				int(kADJ_FORWARD)),
				value("kADJ_BACK",					int(kADJ_BACK)),
				value("kBUY",						int(kBUY)),
