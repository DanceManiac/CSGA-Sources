...
void CUIGameAHunt::Init	()
{
	...
	GameCaptions()->addCustomMessage(m_todo_caption, 0.0f, -0.8f, 0.02f, HUD().Font().GetFont("ui_font_graffiti19_russian"), CGameFont::alCenter, TODO_MSG_COLOR, "");
	GameCaptions()->customizeMessage(m_todo_caption, CUITextBanner::tbsFlicker)->fPeriod = 0.5f;

	m_buy_msg_caption				=	"ah_buy";
	GameCaptions()->addCustomMessage(m_buy_msg_caption, DI2PX(0.0f), DI2PY(0.9f), SZ(0.02f), HUD().Font().GetFont("ui_font_graffiti19_russian"), CGameFont::alCenter, BUY_MSG_COLOR, "");
	//-----------------------------------------------------------
