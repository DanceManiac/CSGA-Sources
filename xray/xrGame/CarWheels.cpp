...
void CCar::SWheelDrive::Init()
{
	...
	CBoneData& bone_data= dynamic_cast<IKinematics*>(pwheel->car->Visual())->LL_GetData(u16(pwheel->bone_id));
...
{
	IKinematics* pKinematics=dynamic_cast<IKinematics*>(pwheel->car->Visual());
	pwheel->Init();
